...
export class UserPage extends WebdriverWrapper {
    ...
    userRestrictedFromEditingPageText = locatorStrategy.generateLocatorForSpan('Editing is restricted for this content');
    ...
    goToPage = async (pageName: string): Promise<void> => {
    ...
    editPageRestrictionsWithOption = async (optionName: RestrictionOptions): Promise<void> => {
      let option;
      switch (optionName) {
